public class Huffman {
	...
	private static Integer downBound = 1;
	private static Integer upBound = 10;
	
	public static void main(String[] args) {
		for(Integer i = downBound;i<=upBound;i++) {
			args[Mode] = "-c";
			args[Frequency_File] = "text"+i.toString()+".fre";
			args[Text_File] = "text"+i.toString()+".txt";
			args[Compressed_File] = "text"+i.toString()+".cmp";
			...
			args[Mode] = "-d";
			args[Frequency_File] = "text"+i.toString()+".fre";
			args[Text_File] = "text"+i.toString()+".dcp";
			args[Compressed_File] = "text"+i.toString()+".cmp";
